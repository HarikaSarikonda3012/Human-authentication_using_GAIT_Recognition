...
fvs = FileVideoStream('data/pavan.mp4', queue_size=1024).start()
time.sleep(1.0)
...
def getValidPairs(generated_output):
    ...
    paf_score_th = 0.1
    conf_th = 0.7
    # loop for every POSE_PAIR showing the part affinity heat maps.
    #This is where the Part Affinity Maps come into play.
    #They give the direction along with the affinity between two joint pairs.
...
#above funtion is end of part affinity heat maps.
